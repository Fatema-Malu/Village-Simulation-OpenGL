...
{
    std::cout << "VILLAGE SCENARIO\n\n";
    std::cout << "************************************************\n\n";
    std::cout << "Press X to move car and Y to stop\n\n";
    std::cout << "Press S to move sun and N to stop\n\n";
    std::cout << "Press C to move cloud and E to stop\n\n";
    std::cout << "Press R to move boat and T to stop\n\n";
    std::cout << "Press B to move car and G to stop\n\n";
    glutInit(&argc, argv);
